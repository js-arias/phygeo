...
func newMP() *model.Model {
	mp := model.New()
	mp.Add("land:wanderlust", model.Walk, 1, 0.05)
	...
	mp.Add("water:wanderlust", model.Walk, 2, 0.05)
	mp.Add("water:ocean", model.Mov, 4, 1)
	mp.Add("water:oceanic plateaus", model.Mov, 4, 1)
	mp.Add("water:lands", model.Mov, 0, 0)
	mp.Add("water:ocean", model.Sett, 0, 0)
	mp.Add("water:oceanic plateaus", model.Sett, 0, 1)
	mp.Add("water:lands", model.Sett, 0, 0)

	mp.Add("land>water:lands", model.Trait, 0, 0)
	mp.Add("land>water:ocean", model.Trait, 0, 0)
	mp.Add("land>water:oceanic plateaus", model.Trait, 5, 0.01)
	mp.Add("water>land:lands", model.Trait, 0, 0)
	mp.Add("water>land:ocean", model.Trait, 0, 0)
	mp.Add("water>land:oceanic plateaus", model.Trait, 5, 0.01)

	mp.SetMax("land:wanderlust", model.Walk, 1)
	mp.SetMax("land:ocean", model.Mov, 1)
	mp.SetMax("land:oceanic plateaus", model.Mov, 1)
	mp.SetMax("water:wanderlust", model.Walk, 1)
	mp.SetMax("water:ocean", model.Mov, 1)
	mp.SetMax("water:oceanic plateaus", model.Mov, 1)
